  ...
  return (
    <div>
      ...
      <QueryBoundary query={query}>
        {(member: MemberOut) => <RegistrationDetailBody member={member} />}
      </QueryBoundary>
    </div>
  );
}
...
function RegistrationDetailBody({ member }: { member: MemberOut }) {
...
function RegistrationActions({ member }: { member: MemberOut }) {
  ...
  const confirmMutation = useApiMutation<MemberOut, void>(
      ...
      ),
    {
      ...
      onSuccess: () => toast.success("Registrierung bestätigt."),
  ...
  return (
    <div className="detail-actions">
      <div className="row-actions">
        <Button busy={busy} onClick={() => confirmMutation.mutate()}>
          Bestätigen
        </Button>
        <Button variant="ghost" busy={busy} onClick={() => mailConfirmMutation.mutate(true)}>
          E-Mail-Bestätigung anfordern
        </Button>
        <Button variant="ghost" busy={busy} onClick={() => mailConfirmMutation.mutate(false)}>
          Fehlende Bestätigungen erneut anfordern
        </Button>
        <Button variant="danger" busy={busy} onClick={() => demoteMutation.mutate()}>
