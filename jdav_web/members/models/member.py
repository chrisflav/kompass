...
from mailer.mailutils import send as send_mail, prepend_base_url, get_mail_confirmation_link, get_invite_as_user_key
...
class Member(Person):
    ...
    def get_skills(self):
        ...
        for kind in ActivityCategory.objects.all():
            ...
            skills[kind.name] = sum([l.difficulty * 3 for l in lists if l.date < timezone.now()])
        return skills
