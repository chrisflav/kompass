...
urlpatterns = [
    ...
    re_path(
        r"^register/download", views.download_registration_form, name="download_registration_form"
    ),
    ...
    re_path(
        r"^waitinglist/invitation/confirm", views.confirm_invitation, name="confirm_invitation"
    ),
