...
class Image(models.Model):
    ...
    f = RestrictedFileField(_("file"), upload_to="images", blank=True, max_upload_size=10)
...
class MemberOnPost(models.Model):
    ...
    post = models.ForeignKey(
        Post, verbose_name=_("Member"), on_delete=models.CASCADE, related_name="people"
    )
